...
if(isset($_SESSION['username'])){
  ...
  <div id="editorback">
    <div id="textbox" class="fr-view">
      <form action="userblogs.php" method="post" id="editor_form">
        <input class="title" id="edit_title" type="text" name="title" placeholder="Title" required>
        <input class="title" id="edit_category" type="text" name="category" placeholder="Category" required>
       ...
       <input type="submit" onclick="updateblog(this.id);" name="blog_edit" class="btn btn-outline-success" value="Post" style="margin-top:7px;float:right;">
        <button type="button" class="btn btn-outline-danger" style="margin-top:7px;" id="cancel_edit">Cancel</button></form>
    </div>
  </div>
  <!-- editor ends -->
    <div id="topbar">
...
<center><div id="pagetag">Your blogs</div></center>
